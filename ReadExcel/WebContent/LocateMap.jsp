...
<script type="text/javascript">
	...
	function getZipValue() {
		...
		window.location.href = "LocateMap.jsp?name=" + zipval;
...
<body onload="loadData()">
	<form action="post">
		Zip Code:<input type="text" id="zip" onkeypress=""> <input
			type="button" value="map" onclick="getZipValue()">
		...
		<script language="JavaScript">
			...
			function loadMap(lati, logi) {
				...
				var map = new google.maps.Map(
						document.getElementById("sample"), mapOptions);

				var marker = new google.maps.Marker({
					position : new google.maps.LatLng(logi, lati),
					map : map,
				});
